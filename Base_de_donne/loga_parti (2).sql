...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 06 sep. 2022 à 14:39
...
CREATE TABLE `bureau` (
  ...
  `photo_bureau` longblob DEFAULT NULL,
...
CREATE TABLE `membre` (
  ...
  `photo_membre` mediumblob DEFAULT NULL,
  `id_bureau` int(11) NOT NULL,
...
CREATE TABLE `user` (
  ...
  `photo_user` mediumblob DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `user` (`id_user`, `login`, `mot_de_pass`, `prenom`, `nom`, `photo_user`) VALUES
(1, 'amadou@gmail.com', 'qw', 'Amadou', 'Maiga', NULL),
(8, 'amadoumaiga1@gmail.com', 'qw', 'Amadou', 'Maiga', NULL),
(9, 'amadoumaiga2@gmail.com', 'qw', 'Amadou', 'Maiga', NULL),
(10, 'amadoumaiga3@gmail.com', 'qw', 'Amadou', 'Maiga', NULL),
(11, 'amadoumaiga4@gmail.com', 'qw', 'Amadou', 'Maiga', NULL),
(12, 'amadoumaiga5@gmail.com', 'qw', 'Amadou', 'Maiga', NULL),
(13, 'amadoumaiga6@gmail.com', 'qw', 'Amadou', 'Maiga', NULL);
